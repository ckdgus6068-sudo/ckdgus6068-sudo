---
name: fluent-korean
description: 의미가 명확하고 자연스러운 한국어 문장을 출력하기 위한 문장 지침. 한국어로 응답을 작성하는 모든 상황에서 이 스킬을 사용한다. 특히 한국어로 보고서·문서·안내문·요약문 등 산문을 작성하거나 교정할 때, 사용자가 "자연스러운 한국어로", "문장 다듬어줘", "번역투 고쳐줘", "한국어로 써줘"라고 요청할 때 반드시 사용한다. 대화가 한국어로 진행되고 있다면 명시적 요청이 없어도 이 스킬을 적용한다.
---

# 유창한 한국어 (fluent-korean)
